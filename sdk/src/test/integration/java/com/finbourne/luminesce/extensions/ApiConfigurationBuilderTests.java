...
import static com.finbourne.luminesce.extensions.TestContants.DUMMY_CREDENTIALS_FILE;
...
public class ApiConfigurationBuilderTests {
    ...
    public void build_WithUnsetEnvironmentVariables_ShouldGetFromFile() throws ApiConfigurationException {
        ...
        assertThat(apiConfiguration.getApiUrl(), equalTo("https://some-non-existing-test-instance.lusid.com/luminesce"));
   ...
   @Test
    ...
    ApiConfiguration validConfigFromEnvVariables(){
        return new ApiConfiguration("https://some-non-existing-test-instance.doesnotexist.com/oauth2/doesnotexist/v1/token","user","pass","client-id-from-env","secret-from-env","https://some-non-existing-test-instance.lusid.com/luminesce","non-existent","pat-token", null,null,null,null);
    }
