...
public class ApiConfigurationBuilderTests {
    ...
    ApiConfiguration validConfigFromEnvVariables(){
        return new ApiConfiguration("https://some-non-existing-test-instance.doesnotexist.com/oauth2/doesnotexist/v1/token","user","pass","client-id-from-env","secret-from-env","https://some-non-existing-test-instance.lusid.com/luminesce","non-existent",null,null,null,null);
    }
